...
const PostCard = ({ post }) => {
  return (
    <div className="bg-white bg-opacity-70 shadow-lg rounded-lg p-0 lg:p-8 pb-12 mb-8">
      ...
      <div className="text-center">
        <Link href={`/post/${post.slug}`} passHref>
          <span
            className="transition duration-500 ease transform hover:-translate-y-1 inline-block 
