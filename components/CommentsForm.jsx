    ...
    <div className="bg-white bg-opacity-70 shadow-lg rounded-lg p-8 pb-12 mb-8">
      ...
      <div className="grid grid-cols-1 gap-4 mb-4">
        <textarea
          ...
          className="p-4 outline-none w-full rounded-lg h-40 focus:ring-2 focus:ring-pink-600 
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-4 mb-4">
        <input
          ...
          value={formData.name}
          onChange={onInputChange}
          className="py-2 px-4 outline-none w-full rounded-lg focus:ring-2 focus:ring-pink-600 
          bg-white text-gray-700"
          placeholder="Name"
          name="name"
        />
